"""Evaluates a scripts/train_windowed_combined.py checkpoint on the held-out
...
scripts/evaluate_windowed.py (full binary-classification metric suite:
...
Usage:
    python scripts/evaluate_windowed_combined.py [--checkpoint best|last]
"""
...
def main(checkpoint: str = "best") -> dict:
    ...
    if not checkpoint_path.exists():
        raise FileNotFoundError(f"{checkpoint_path} not found — run scripts/train_windowed_combined.py first")
