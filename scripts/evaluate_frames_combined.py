"""Evaluates a scripts/train_frames_combined.py checkpoint on the held-out
...
scripts/evaluate.py (full binary-classification metric suite: accuracy,
...
Usage:
    python scripts/evaluate_frames_combined.py [--checkpoint best|last]
"""
...
def main(checkpoint: str = "best") -> dict:
    ...
    if not checkpoint_path.exists():
        raise FileNotFoundError(f"{checkpoint_path} not found — run scripts/train_frames_combined.py first")
